export default class BoardLogic {
    ...
    */
    ...
    /**
     * Getter, returns a copy of the game board 
     */
    get board() {
     ...
     * return the empty space location
     */
    move(i, j) {
     ...
     * return true if board is in win configuration
     */
    checkWin() {
     ...
     * returns a copy of the scrambled board
     */
    scramble() {
